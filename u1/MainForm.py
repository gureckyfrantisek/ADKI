...
class Ui_MainForm(object):
    def setupUi(self, MainForm):
        ...
        self.actionClear.triggered.connect(lambda: self.Canvas.clearSelection(self.Log))
        icon3 = QtGui.QIcon()
        ...
        self.actionRay_Crossing.triggered.connect(lambda: self.Canvas.analyze(1, self.Log))
        icon4 = QtGui.QIcon()
        ...
        self.actionWinding_Number.triggered.connect(lambda: self.Canvas.analyze(2, self.Log))
        icon5 = QtGui.QIcon()
